...
public class SupportedLanguagesRestDS extends AbstractRestDS{
...
private String appName = null;
	...
	public SupportedLanguagesRestDS(String appName) {
		this.appName = appName;
	...
	protected void setEntityFields() {
        ...
        DataSourceTextField languageName = new DataSourceTextField("languageName", Constants.languageNameLabel());  
        DataSourceTextField languageCode = new DataSourceTextField("languageCode", Constants.languageCodeLabel());  
        DataSourceTextField description = new DataSourceTextField("description",Constants.descriptionLabel()); 
     
        addField(appName);
        addField(languageName);
        addField(languageCode);
