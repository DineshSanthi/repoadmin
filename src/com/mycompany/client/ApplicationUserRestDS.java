...
public class ApplicationUserRestDS extends AbstractRestDS{
...
private String appName = null;
	...
	public ApplicationUserRestDS(String appName) {
		this.appName = appName;
	...
	protected void setEntityFields() {
		...
		DataSourceTextField userName = new DataSourceTextField("userName", Constants.userNameLabel());
        DataSourceTextField email = new DataSourceTextField("email", Constants.emailLabel());  
        DataSourceTextField firstName = new DataSourceTextField("firstName", Constants.firstNameLabel());  
        DataSourceTextField lastName = new DataSourceTextField("lastName",Constants.lastNameLabel()); 
