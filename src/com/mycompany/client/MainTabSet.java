...
public class MainTabSet extends TabSet{
	...
	public MainTabSet(final ApplicationInstance appInstance)
	{
        ...
        tTab2.addTabSelectedHandler(new TabSelectedHandler() {
			...
			public void onTabSelected(TabSelectedEvent event) {
				String appName = appInstance.getResultsListGrid().getSelectedRecord().getAttribute("appName");
				Tab newTab = new Tab(appName);
				newTab.setCanClose(true);
				newTab.setCanEditTitle(true);		   
				newTab.setPane(new ApplicationInstance(appName));
