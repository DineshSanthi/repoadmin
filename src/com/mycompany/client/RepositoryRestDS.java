...
public class RepositoryRestDS extends DataSource {
    ...
    public RepositoryRestDS(String id) {
        ...
        if(id == null)
        {
            ...
            this.addData(createRecord("user", Constants.userEntityLabel()));
            this.addData(createRecord("role", Constants.roleEntityLabel()));
            this.addData(createRecord("reference", Constants.referenceTableEntityLabel()));
            this.addData(createRecord("globalproperties", Constants.globalPropertyEntityLabel()));
        }
        else
        {	
            ...
            this.addData(createRecord("profile", Constants.profileEntityLabel()));
        }
