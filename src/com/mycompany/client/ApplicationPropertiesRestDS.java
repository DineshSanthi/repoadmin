...
public class ApplicationPropertiesRestDS extends AbstractRestDS{
...
private String appName = null;
	...
	public ApplicationPropertiesRestDS(String appName) {
		this.appName = appName;
	...
	protected void setEntityFields() {
        ...
        addField(propertyDesc);
        addField(propertyValue);
	}
