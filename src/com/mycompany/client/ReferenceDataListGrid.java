...
public class ReferenceDataListGrid extends ListGrid {

	private static final ApplicationMessages Constants = ApplicationMessages.INSTANCE;
    public ReferenceDataListGrid(DataSource restDS) {


        ListGridField refId = new ListGridField("refId",Constants.referenceIdLabel());
        refId.setShowHover(true);
        ListGridField code = new ListGridField("code",Constants.codeLabel());
        code.setShowHover(true);
        ListGridField displayValue = new ListGridField("displayValue",Constants.displayValueLabel());
        displayValue.setShowHover(true);
        ListGridField displayValueTamil = new ListGridField("displayValueTamil",Constants.displayValueTamilLabel());
        displayValueTamil.setShowHover(true);
        ListGridField displayValueTelugu = new ListGridField("displayValueTelugu",Constants.displayValueTeluguLabel());
...
*/
        setFields(refId,code,displayValue);
        setCanEdit(false);
