...
public interface ApplicationMessages extends Messages{
    ...
    @DefaultMessage("Global Properties")
    public String globalPropertyEntityLabel();
	...
	public String propertyDescLabel();
	@DefaultMessage("Property Value")
	public String propertyValueLabel();
	
	//SupportedLanguages
	@DefaultMessage("Language Name")
	public String languageNameLabel();
	@DefaultMessage("Language Code")
	public String languageCodeLabel();
	@DefaultMessage("Role Name")
	public String roleNameLabel();
	@DefaultMessage("Role")
	public String roleEntityLabel();
	@DefaultMessage("User")
	public String userEntityLabel();
	@DefaultMessage("Profile")
	public String profileEntityLabel();
	
	
	@DefaultMessage("Profile Name")
	public String profileNameLabel();
	@DefaultMessage("Operation ID")
	public String operationIdLabel();
